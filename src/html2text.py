...
#def wrapwrite(text): sys.stdout.write(text.encode('latin1'))
...
if __name__ == "__main__":
	if sys.argv[1:]:
		...
		if arg.startswith('http://'):
			...
			data = trytodecode(open(arg, 'r').read()) #.decode('latin1')
	else:
		data = trytodecode(sys.stdin.read())
	html2text_file(data)
